...
$priceTime = 3;
$addGPS = true;
$base = new Base($dist, $timeMin, $age, ['addGPS' => $addGPS]);
echo '<br><br>';
...
$addGPS = true;
$addDriver = true;
$hourly  = new Hourly($dist, $timeMin, $age, ['addGPS' => $addGPS, 'addDriver' => $addDriver]);
echo '<br><br>';
...
$addGPS = true;
$addDriver = false;
$daily  = new Daily($dist, $timeMin, $age, ['addGPS' => $addGPS, 'addDriver' => $addDriver]);
echo '<br><br>';
...
$priceTime = 1;
$addGPS = true;
$stud  = new Student($dist, $timeMin, $age, ['addGPS' => $addGPS]);
echo '<br><br>';
